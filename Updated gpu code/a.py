...
time_series = dataframe[['sub_meter_1', 'weekend', 'corporate', 'day of week_0','day of week_1','day of week_2','day of week_3','day of week_4','day of week_5','day of week_6']]#,'building_number_1','building_number_2','building_number_3','building_number_4','building_number_5']] #'building_number','Hour', 'day of week']]#
...
val = "building2_1hr_sigmoid_sub_meter_1_adam_1_try1"
...
lstm_model.fit(X_train, y_train, epochs=35, batch_size = 1024)
...
print(evalution_metric(actual_test_data,pred,df_test.index))
